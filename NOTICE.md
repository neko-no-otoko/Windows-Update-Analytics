...
Win11UpgradeDiag does not redistribute SetupDiag. When internet use is enabled, it downloads SetupDiag from Microsoft's current official redirect, verifies a valid Microsoft Authenticode signer, caches the verified executable under ProgramData, and runs it with `/NoTel`.
